...
issuer = "https://dev-7y0f80mrzcvwseav.eu.auth0.com/" # This is a value from an environment variable. It allows us to not hard code some information
audience = "https://sparikh-cats-dogs.com" # this line is new
